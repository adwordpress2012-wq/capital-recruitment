...
type CandidateApplicationFormSectionProps = {
  defaultRole: string;
  submitButtonLabel?: string;
};

export function CandidateApplicationFormSection({
  defaultRole,
  submitButtonLabel = "Submit application",
}: CandidateApplicationFormSectionProps) {
          ...
          {!useSupabase ? (
            ...
            >
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <NativeField label="Location (suburb / city)" name="location" type="text" required />
                <NativeField
                ...
                />
                <div>
                  <label className="text-xs font-semibold text-muted-foreground">Preferred industry</label>
                  <select
